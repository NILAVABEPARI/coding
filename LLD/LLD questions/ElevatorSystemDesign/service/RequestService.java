...
public class RequestService {
    ...
    public void assignRequestToElevator(String requestId, String elevatorId) {
        externalRequestRepository.findById(requestId).ifPresent(request -> {
            ...
            // CRITICAL: Create corresponding internal request so elevator actually moves to
            // the floor
            ...
            System.out.println("Created internal request for elevator " + elevatorId
                    + " to serve external request at floor " + request.getFloorNumber());
        });
    }
    ...
    public void initiateGracefulShutdownForBuilding(String buildingId) {
        ...
        System.out.println(
                "Graceful shutdown initiated for building " + buildingId + " - allowing pending requests to complete");
    }
