 ...
 * This state blocks new external requests but completes existing internal
 * requests gracefully
 */
public class PreMaintenanceState implements ElevatorStateHandler {
    ...
    public void checkForMaintenanceTransition(Elevator elevator) {
        // This method should be called by external services to check if we can
        // transition
        System.out.println("Pre-maintenance elevator " + elevator.getId()
