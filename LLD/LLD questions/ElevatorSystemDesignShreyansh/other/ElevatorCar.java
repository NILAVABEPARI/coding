...
public class ElevatorCar {
    ...
    public void moveElevator(int destinationFloor) {
        // this is dump object, so if command has come, to go particular direction and
        // particular floor, it just move
        ...
        if (nextFloorStoppage >= currentFloor) {
            ...
            showDisplay();
            // +1 i am doing because, floor start from 0,1,2.... so if anyone goes from 1st
            // floor to 2nd, so only 1 floor lift has to move, not 2.
