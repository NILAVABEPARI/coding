...
public class NearestElevatorStrategy implements ElevatorSelectionStrategy {
    ...
    public ElevatorController selectElevator(List<ElevatorController> controllers,
        ...
        // 1. Pick the one which is going in same direction and minimum distance from
        // the destination
        ...
        if (best == null) {
            ...
            // reached here means, no list is going in same direction and no lift is IDLE
            // too, then pick any lift
            if (best == null) {
