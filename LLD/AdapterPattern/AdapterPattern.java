...
class RazorpayAPI {
    public void makePayment(String invoiceId, double amountInRupees) {
        System.out.println("Paid Rs. " + amountInRupees + " using Razorpay for order: " + invoiceId);
    }
}
...
public class AdapterPattern {
    public static void main(String[] args) {
        ...
        checkoutServicePayU.checkout("12", 1780);

        // Using razorpay payment gateway adapter to process payment
        CheckoutService checkoutServiceRazor = new CheckoutService(new RazorpayAdapter());
        checkoutServiceRazor.checkout("122", 14780);
    }
}